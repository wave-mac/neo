  ...
  return (
    <section className="pt-[140px] pb-20 relative overflow-hidden text-center bg-[radial-gradient(circle_at_top_right,rgba(230,81,0,0.05),transparent_60%)]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mt-16 mx-auto max-w-[900px] rounded-2xl border border-slate-200 shadow-premium bg-white overflow-hidden relative aspect-video animate-float">
          <div className="h-10 bg-slate-100 border-b border-slate-200 flex items-center px-4 gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-red-500"></div>
            <div className="w-2.5 h-2.5 rounded-full bg-amber-500"></div>
            <div className="w-2.5 h-2.5 rounded-full bg-emerald-500"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[240px_1fr] h-[calc(100%-40px)] bg-slate-50">
            ...
            <div className="p-8 flex flex-col gap-6">
              <div className="h-[120px] rounded-xl bg-gradient-to-r from-primary/10 to-primary/20 flex items-center px-8 font-museo text-2xl sm:text-3xl text-primary font-extrabold border border-dashed border-primary/30">
                Welcome to Vectore Cohort #1
              </div>
              <div className="grid grid-cols-[2fr_1fr] gap-6">
                <div className="h-[160px] bg-white border border-slate-200 rounded-xl p-5 flex flex-col gap-3">
